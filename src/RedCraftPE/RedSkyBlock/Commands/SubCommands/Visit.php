		...
		if (isset($args["target"])) {
			...
			if ($island instanceof Island) {
				...
				if (!in_array(strtolower($sender->getName()), $banned, true)) {
					...
					if (!$lockStatus || in_array(strtolower($sender->getName()), $members, true) || $sender->hasPermission("redskyblock.bypass") || $islandCreator === $sender->getName()) {
				...
				if ($this->checkIsland($player)) {
					...
					if (!in_array(strtolower($sender->getName()), $banned, true)) {
						...
						if (!$lockStatus || in_array(strtolower($sender->getName()), $members, true) || $sender->hasPermission("redskyblock.bypass") || $sender->getName() === $islandCreator) {
